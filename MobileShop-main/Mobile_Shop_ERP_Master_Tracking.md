...
- ✅ `SECURITY.md`.
- ✅ `docs/RELEASE_GATES.md` (consolidated from the now-removed `docs/PRODUCTION_RELEASE_PLAN.md`, `docs/MASTER_TRACKING_RC3.md`, `docs/IMPLEMENTATION_STATUS.md`, `docs/PHASE_0.md`, `docs/PHASE_1.md`, `docs/PHASES_2_10.md`, `docs/PROJECT_STATUS.md` — all superseded by this file).
