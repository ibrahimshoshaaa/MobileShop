...
abstract class SalesRepository {
  ...
  /// All sales (any status) with createdAt in [from, to) — from inclusive,
  /// to exclusive. Either bound may be omitted to leave that side open.
  /// Used by reports, which need every sale in a period, not just the most
  /// recent N.
  Future<List<SaleRecord>> listSalesInRange({DateTime? from, DateTime? to});
